...
Исправленная версия с корректным выводом видео в редакторе. которое исправляет 412 ошибку (precondition failed )
Собственно для того чтобы корректно выводилось видео, необходимо чтобы в URL который отдает бекенд, название видео файла состояло из название_файла_video.mp4 - пример
